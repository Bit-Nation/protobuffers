...
func (MessageStateChange_NewState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{5, 0}
}
...
func (*DoubleRatchedMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{0}
}
...
func (*PlainChatMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{1}
}
...
func (*ChatMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{2}
}
...
func (*PreKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{3}
}
...
func (*PreKeyBundle) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{4}
}
...
func (*MessageStateChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{5}
}
...
func (*BackendMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{6}
}
...
func (*BackendMessage_Auth) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{6, 0}
}
...
type BackendMessage_Request struct {
	...
	NewOneTimePreKeys    uint32               `protobuf:"varint,6,opt,name=newOneTimePreKeys" json:"newOneTimePreKeys,omitempty"`
	PreKeyBundle         []byte               `protobuf:"bytes,7,opt,name=preKeyBundle,proto3" json:"preKeyBundle,omitempty"`
	Auth                 *BackendMessage_Auth `protobuf:"bytes,8,opt,name=auth" json:"auth,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (*BackendMessage_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{6, 1}
}
...
type BackendMessage_Response struct {
	...
	OneTimePrekeys       []*PreKey                    `protobuf:"bytes,5,rep,name=oneTimePrekeys" json:"oneTimePrekeys,omitempty"`
	Auth                 *BackendMessage_Auth         `protobuf:"bytes,8,opt,name=auth" json:"auth,omitempty"`
...
func (*BackendMessage_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{6, 2}
}
...
func (*BackendMessage_PreKeyBundle) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_1e6740bc9c433815, []int{6, 3}
}
...
func init() { proto.RegisterFile("chat.proto", fileDescriptor_chat_1e6740bc9c433815) }

var fileDescriptor_chat_1e6740bc9c433815 = []byte{
	...
	,
}
